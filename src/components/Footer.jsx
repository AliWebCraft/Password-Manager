...
const Footer = () => {
  return (
    <div className='fixed bottom-0 w-full bg-slate-800 flex flex-col text-center p-[1px] z-auto'>
        ...
        <span><p className='flex justify-center text-white font-bold text-sm'>Created with <img width={"20px"} className='m-1' src="icons/heart.png" alt=" love " />by ProCoderAli</p></span>
